...
public interface Consts {
   ...
   */
  public static final String PROJECT_ID = "swift-approach-380";

  /**
   * Set Project Number of your Google APIs Console Project.
   */
  public static final String PROJECT_NUMBER = "470691161708";

  /**
   * Set your Web Client ID for authentication at backend.
   */
  public static final String WEB_CLIENT_ID = "AIzaSyAoCKOGahfcDy5yTnRDITSLyu1QEKK7OYU";
